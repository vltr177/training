...
# При анализе продаж книг выяснилось, что наибольшей популярностью пользуются книги Михаила Булгакова, на втором месте книги Сергея Есенина. Исходя из этого решили поднять цену книг Булгакова на 10%, а цену книг Есенина - на 5%.
...
# Вывести название книги, автора, и суммарную стоимость для книг с именем total, при условии что она более 2000.
# Отсортировать в порядке убывания стоимости.
SELECT title, author, price*amount AS total FROM book
WHERE price*amount > 2000
ORDER BY total DESC
